...
export default function Approach() {
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-slate-900 px-6 py-40 lg:px-10 lg:py-52">
        {/* Background image */}
      ...
      <section className="relative bg-slate-900 px-6 py-24 lg:px-10 lg:py-32">
      ...
      {/* ── ARE YOU COMMITTED ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-[var(--peach)] to-[var(--peach-deep)] px-6 py-24 lg:px-10 lg:py-32">
