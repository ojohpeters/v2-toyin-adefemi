...
export default function FamilyCounseling() {
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-amber-950 px-6 py-40 lg:px-10 lg:py-52">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-amber-400/30 bg-amber-400/10 px-4 py-2 backdrop-blur-sm">
              <span className="h-2 w-2 rounded-full bg-amber-400" />
              <span className="text-xs font-bold uppercase tracking-widest text-amber-300">Family Counseling</span>
            </div>
            <h1 className="mt-4 text-5xl font-bold leading-[1.08] tracking-tight text-white sm:text-6xl lg:text-7xl">
              ...
              <span className="text-amber-300">Restoring Peace</span><br />
              at Home
            </h1>
      ...
      <section className="relative bg-white px-6 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
            ...
            <div>
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-amber-600">Together</p>
                ...
                {helps.map((item) => (
                  <li key={item} className="flex items-center gap-4">
                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-amber-100">
                      <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 text-amber-600" aria-hidden="true">
        ...
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-14 flex flex-wrap justify-center gap-3">
            {topics.map((topic) => (
              <span
                key={topic}
                className="rounded-full border border-amber-200 bg-white px-5 py-3 text-sm font-medium text-slate-700 shadow-sm transition-all hover:border-amber-400 hover:bg-amber-50 hover:text-amber-700"
              >
                {topic}
              </span>
            ))}
      ...
      <section className="relative bg-white px-6 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-[1fr_380px] lg:items-start lg:gap-20">
            ...
            <div>
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-amber-600">Each Session</p>
              <h2 className="text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
              ...
              <ul className="mt-8 space-y-4">
                {sessionIncludes.map((item) => (
                  <li key={item} className="flex items-start gap-4">
                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-amber-100 mt-0.5">
                      <svg viewBox="0 0 20 20" fill="currentColor" className="h-3.5 w-3.5 text-amber-600" aria-hidden="true">
                        <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
                      </svg>
                    </span>
            ...
            <div className="space-y-5 lg:sticky lg:top-28">
              <div className="overflow-hidden rounded-3xl bg-amber-950 p-8 text-white shadow-[0_20px_52px_rgba(146,64,14,0.20)]">
                <p className="text-xs font-bold uppercase tracking-widest text-amber-300">Investment</p>
                <div className="mt-4 flex items-end gap-2">
                  <span className="text-6xl font-black">$150</span>
                  <span className="mb-2 text-lg text-amber-300">/ session</span>
                </div>
              ...
              <div className="rounded-2xl border border-slate-100 bg-slate-50 p-6">
                <p className="text-sm font-bold text-slate-900">Your Family Can Heal</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">Your home doesn&apos;t have to stay in survival mode. With the right support, your family can rebuild connection and experience the peace God desires for your household.</p>
              </div>
            </div>
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden bg-amber-950 px-6 py-24 lg:px-10 lg:py-32">
