...
export default function YoungAdultCounseling() {
  return (
    <>
      ...
      {/* ── HERO ── */}
      <section className="relative overflow-hidden bg-emerald-950 px-6 py-40 lg:px-10 lg:py-52">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="max-w-3xl">
            <div className="mb-5 inline-flex items-center gap-2 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-4 py-2 backdrop-blur-sm">
              <span className="h-2 w-2 rounded-full bg-emerald-400" />
              <span className="text-xs font-bold uppercase tracking-widest text-emerald-300">Young Adult Counseling · Ages 18–30</span>
            </div>
            <h1 className="mt-4 text-5xl font-bold leading-[1.08] tracking-tight text-white sm:text-6xl lg:text-7xl">
              Clarity, Healing &<br />
              <span className="text-emerald-300">Direction</span><br />
              for This Season
            </h1>
      ...
      <section className="relative bg-white px-6 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-2 lg:items-center lg:gap-24">
            ...
            <div>
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-emerald-600">Your Safe Space</p>
              <h2 className="text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
                A Safe Space<br />to Grow
              </h2>
              <div className="mt-5 h-1 w-14 rounded-full bg-emerald-400" />
              ...
              <ul className="mt-8 space-y-3">
                {pillars.map((p) => (
                  <li key={p.label} className="flex items-center gap-3">
                    ...
                    <span className="text-base text-slate-700">{p.label}</span>
                  </li>
                ))}
              </ul>
            </div>
      ...
      {/* ── TOPICS ── */}
      <section className="relative bg-emerald-950 px-6 py-24 lg:px-10 lg:py-32">
        <div className="pointer-events-none absolute inset-0 bg-[linear-gradient(rgba(255,255,255,0.02)_1px,transparent_1px),linear-gradient(90deg,rgba(255,255,255,0.02)_1px,transparent_1px)] bg-[size:48px_48px]" />
        <div className="relative mx-auto max-w-7xl">
          <div className="mx-auto max-w-2xl text-center">
            <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-emerald-400">You&apos;re Not Alone In This</p>
            <h2 className="text-4xl font-bold text-white sm:text-5xl">What We Can Work Through</h2>
            <div className="mx-auto mt-5 h-1 w-14 rounded-full bg-emerald-400" />
          ...
          <div className="mt-14 flex flex-wrap justify-center gap-3">
            {topics.map((topic) => (
              <span
                key={topic}
                className="rounded-full border border-emerald-700/50 bg-emerald-900/50 px-5 py-3 text-sm font-medium text-emerald-100 backdrop-blur-sm transition-all hover:border-emerald-400 hover:bg-emerald-800"
              >
                {topic}
              </span>
            ))}
      ...
      <section className="relative bg-white px-6 py-24 lg:px-10 lg:py-32">
        <div className="mx-auto max-w-7xl">
          <div className="grid gap-16 lg:grid-cols-[1fr_380px] lg:items-start lg:gap-20">
            ...
            <div>
              <p className="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-emerald-600">Each Session</p>
              <h2 className="text-4xl font-bold leading-tight text-slate-900 sm:text-5xl">
              ...
              <ul className="mt-8 space-y-4">
                {sessionIncludes.map((item) => (
                  <li key={item} className="flex items-start gap-4">
                    <span className="flex h-6 w-6 flex-shrink-0 items-center justify-center rounded-full bg-emerald-100 mt-0.5">
              ...
              <div className="mt-10 rounded-2xl border-l-4 border-emerald-400 bg-emerald-50 px-6 py-5">
            ...
            <div className="space-y-5 lg:sticky lg:top-28">
              <div className="overflow-hidden rounded-3xl bg-emerald-950 p-8 text-white shadow-[0_20px_52px_rgba(16,185,129,0.15)]">
                <p className="text-xs font-bold uppercase tracking-widest text-emerald-300">Investment</p>
                <div className="mt-4 flex items-end gap-2">
                  <span className="text-6xl font-black">$90</span>
                  <span className="mb-2 text-lg text-emerald-300">/ session</span>
                </div>
              ...
              <div className="rounded-2xl border border-slate-100 bg-slate-50 p-6">
                <p className="text-sm font-bold text-slate-900">You Can Move Forward</p>
                <p className="mt-2 text-sm leading-6 text-slate-600">With the right support, you can heal, grow, and step into your God-given identity with confidence.</p>
              </div>
            </div>
      ...
      {/* ── CTA ── */}
      <section className="relative overflow-hidden bg-gradient-to-br from-emerald-950 to-slate-900 px-6 py-24 lg:px-10 lg:py-32">
